...
public class Fetch extends RunPipeline {
	...
	public Fetch(MainWindow mw, InternalRegister ir, UpdatedPipeline pipelining)
	{
		super(ir, pipelining);
		this.mw = mw;
		...
		try
		{
			...
			else if (peek != null)
			{
				...
				/* FETCH START! */
					...
					pipelineController.setMapValue("IF", inst.getIndex(), cycleNumber);
	...
	private boolean isNotEqualRegisters(String reg1, String reg2) {
		if (reg1 == null || reg2 == null)
			...
			String val1 = registerController.getValue(index1, 1);
			String val2 = registerController.getValue(index2, 1);
			if (!val1.equals(val2))
				return true;
			else return false;
		}
